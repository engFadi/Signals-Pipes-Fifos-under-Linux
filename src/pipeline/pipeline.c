...
int run_pipeline(int child_count,
    ...
    furniture_piece *shared_furniture = furniture;
    int owns_shared_furniture = (visual == NULL);
    if (owns_shared_furniture) {
        shared_furniture = pipeline_map_shared_furniture(furniture, furniture_count);
